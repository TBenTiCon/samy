...
//oldPW => $2b$10$gh7aNEuoxMBN/LQf2evP0uYei54m00GScwCjWh7toepi/jUFcGg0e

module.exports.createPW = async (req, res) => {
  await hashPassword("ante2020")
    .then(async (pw) => {
      console.log(pw);
